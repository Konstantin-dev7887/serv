...
class OwnerRequiredMixin(UserPassesTestMixin):
    def test_func(self):
        ...
        if user.has_perm('mailing.can_view_all_mailings') and self.request.method in ['GET', 'HEAD', 'OPTIONS']:
            return True
...
def send_mailing_now(request, pk):
    ...
    if request.user != mailing.owner and not request.user.has_perm('mailing.can_view_all_mailings'):
